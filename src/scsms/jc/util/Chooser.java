...
public class Chooser extends JPanel{
    ...
    public Chooser() {
    	...
    	btnNewButton.setBounds(27, 198, 93, 23);
    	add(btnNewButton);
    ...
    public  void selectDate() {
        JFrame jf = new JFrame("日期选择");
      //  jf.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        jf.getContentPane().setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
        jf.setBounds(400, 200, 350, 250);
        
        Chooser ser = Chooser.getInstance();
        final javax.swing.JTextField text = new JTextField();
        JButton oKButton=new JButton("确认选择");
        text.setBounds(10, 10, 200, 30);
        text.setText("2014-12-20");
        ser.register(text);
       
        
        Chooser ser2 = Chooser.getInstance("yyyy年MM月dd日");
        JLabel label = new JLabel("点击选择日期.");
